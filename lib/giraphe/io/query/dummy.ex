...
defmodule Giraphe.IO.Query.Dummy do
  ...
  defp _query_addresses("203.0.113.20") do
    [ "203.0.113.20/31",
      "203.0.113.22/31",
    ]
  end

  defp _query_addresses("203.0.113.21") do
    [ "203.0.113.21/31",
      "203.0.113.24/31",
    ]
  end

  defp _query_addresses("203.0.113.23") do
    [ "203.0.113.23/31",
      "203.0.113.26/31",
    ]
  end
  ...
  defp _query_addresses(target)
      when target in ["203.0.113.25", "203.0.113.27"]
  do
    [ "203.0.113.25/31",
      "203.0.113.27/31",
    ]
  ...
  defp _query_routes("203.0.113.20") do
    [ {"203.0.113.20/31", "0.0.0.0"},
      {"203.0.113.22/31", "0.0.0.0"},
      {"203.0.113.24/31", "203.0.113.21"},
      {"203.0.113.26/31", "203.0.113.23"},
    ]
  end

  defp _query_routes("203.0.113.21") do
    [ {"203.0.113.20/31", "0.0.0.0"},
      {"203.0.113.24/31", "0.0.0.0"},
      {"203.0.113.22/31", "203.0.113.20"},
      {"203.0.113.26/31", "203.0.113.25"},
    ]
  end

  defp _query_routes("203.0.113.23") do
    [ {"203.0.113.22/31", "0.0.0.0"},
      {"203.0.113.26/31", "0.0.0.0"},
      {"203.0.113.20/31", "203.0.113.22"},
      {"203.0.113.24/31", "203.0.113.27"},
    ]
  end
  ...
  do
    [ {"203.0.113.24/31", "0.0.0.0"},
      {"203.0.113.26/31", "0.0.0.0"},
      {"203.0.113.20/31", "203.0.113.24"},
      {"203.0.113.22/31", "203.0.113.26"},
    ]
  end
